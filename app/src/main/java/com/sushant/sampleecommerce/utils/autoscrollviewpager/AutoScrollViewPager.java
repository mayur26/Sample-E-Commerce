package com.sushant.sampleecommerce.utils.autoscrollviewpager;
...
public class AutoScrollViewPager extends ViewPager {
    ...
    private void sendScrollMessage(long delayTimeInMills) {
        /** remove messages before, keeps one_selected message is running at most **/
        handler.removeMessages(SCROLL_WHAT);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || slideBorderMode == SLIDE_BORDER_MODE_CYCLE) {
            ...
            /**
             * current index is first one_selected and slide to right or current index is last one_selected and slide to left.<br/>
             * if slide border mode is to parent, then requestDisallowInterceptTouchEvent false.<br/>
             * else scroll to last one_selected when current item is first one_selected, scroll to first one_selected when current item is last
             * one_selected.
             */
